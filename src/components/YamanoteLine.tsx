...
import { useCoordinateTransformation, useUserPosition } from '../hooks/useYamanoteLine';
import { useTrainPositions } from '../hooks/useTrainPositions';
import { useTrainCoordinates } from '../hooks/useTrainCoordinates';
...
export const YamanoteLine = ({ width = 300, height = 300, userPosition, closestStation }: Props) => {
  ...
  const transformedTrains = useTrainCoordinates(trainPositions, 1000, 1000);
